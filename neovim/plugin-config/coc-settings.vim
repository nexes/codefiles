" Coc settings and keybindings. Mosting pulled from https://github.com/neoclide/coc.nvim
" 
...
" Codelens
nmap <silent> <F12> <Plug>(coc-codelens-action)
...
xmap <key>=  <Plug>(coc-format-selected)
nmap <key>=  <Plug>(coc-format-selected)
